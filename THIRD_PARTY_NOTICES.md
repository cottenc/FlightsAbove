...
FlightsAbove includes generated aircraft marker sprites derived from these
projects:
...
- Use: family fallback aircraft marker sprites
...
- License: GPL-3.0
- Use: curated exact type-code aircraft marker sprites
