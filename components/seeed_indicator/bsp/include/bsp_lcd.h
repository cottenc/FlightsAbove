...
/**
 * @brief Resynchronize an RGB panel's DMA stream at the next VSYNC
 *
 * @return
 *    - ESP_OK: Restart requested
 *    - ESP_ERR_NOT_SUPPORTED: The board does not use an RGB panel
 *    - Others: Restart request failed
 */
